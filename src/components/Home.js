...
//   const iralcurso = (x, mate) => {
//     navigate("/cursos/"+mate+"/"+x)
//   }
...
//           <button 
//           class="boton home-boton" 
//           onClick={() => (setCurrent(Math.floor(Math.random() * renderPreguntas.length)), setMostComent(false), setShow(false))}>
//             Pregunta aleatoria ⚄
//           </button>
//           <button 
//           class="boton home-boton" 
...
//           <div class="home">
//           {preguntas.map((a) => {
//             if (renderId[current] === a.id) {
//               return (
//                 <div
//                 className='home-capitulo'
//                 >
//                   <p>
//                     Pregunta del capitulo:
//                   {a.capitulo ?
//                 <button
//                 className='home-capitulo1'
//                 onClick={() => iralcurso(a.capitulo, a.materia)}
//                 >
//                   {a.capitulo}
//                 </button>
//                 : <span> -</span>
...
//             </div>
//             {!mostComent &&
//             <button class="boton home-boton" onClick={comentar}>
//               Comentar
//             </button>
// }
//             <br></br>
