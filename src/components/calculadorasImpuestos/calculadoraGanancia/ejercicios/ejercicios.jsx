...
import { ControlarEjercicio } from "./controlarEjercicio"

export const Ejercicios = ({ obtenerLiquidacion, controlarEjercicio, funcionLiquidar }) => {

  const [verTest, setVerTest] = useState(false)

  return (
    <div className="ejerciciosContenedor">
      <div className="ejerciciosLiquidaciones">
        <button className={verTest ? "home-boton" : "home-boton botonmostrar"} onClick={() => setVerTest(false)}>Consigna</button>
        <button className={verTest ? "home-boton botonmostrar" : "home-boton"} onClick={() => setVerTest(true)}>Tests</button>
        <div style={{ display: verTest ? "block" : "none" }}>
        <ControlarEjercicio funcionLiquidar={funcionLiquidar} controlarEjercicio={controlarEjercicio} />
        </div>
        <div style={{ display: verTest ? "none" : "block" }}>
          <div>Cargar Resolución <CargarLiquidaciones obtenerLiquidacion={obtenerLiquidacion} /></div>
